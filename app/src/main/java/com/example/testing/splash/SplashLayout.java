...
public class SplashLayout extends RelativeLayout {
    ...
    private void initView(Context context) {
        ...
        mJumpbtn.setTextColor(getResources().getColor(R.color.white));
        ...
        lp = new LayoutParams(ViewGroup.LayoutParams.WRAP_CONTENT, dp2px(context, 30));
        lp.addRule(RelativeLayout.ALIGN_PARENT_RIGHT);
        lp.addRule(RelativeLayout.ALIGN_PARENT_TOP);
        lp.setMargins(0, dp2px(context, 20), dp2px(context, 20), 0);
        addView(mJumpbtn, lp);
    }
